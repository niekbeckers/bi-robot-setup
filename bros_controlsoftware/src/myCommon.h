...
struct trialData {
	...
	vector<double> targetPosSD = { 0.001, 0.001 }; // target position variance for resampling child position 
	vector<double> targetVelSD = { 0.001, 0.001 }; // target velocity variance for resampling child velocity 
};
...
struct experimentSettings {
	...
	int numTrials = 0;
	int targetParticleCount = 10;
	double targetParticlePeriod = 0.5f;
	double targetParticleSize = 4.0f;
	string protocolname;
