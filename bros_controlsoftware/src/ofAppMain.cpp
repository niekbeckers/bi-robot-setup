...
void ofAppMain::setup(){
	...
	try {
		ofBuffer buffer = ofBufferFromFile("C:\\Users\\TCUser\\Documents\\repositories\\bros_experiments\\libraries\\BROSErrorDescriptions.txt");
...
void ofAppMain::setupGUI()
{
	...
	_btnToggleTargetType.addListener(this, &ofAppMain::toggleTargetTypePressed);
...
//--------------------------------------------------------------
void ofAppMain::toggleTargetTypePressed(bool & value)
{
	if (value) {
...
void ofAppMain::exit() {
	...
	_btnToggleTargetType.removeListener(this, &ofAppMain::toggleTargetTypePressed);
