...
void childParticle::reset()
{
    ...
    frc = ofPoint(0.0, 0.0, 0.0);
    //drag  = ofRandom(0.95, 0.998);
    
	scale = 1.0f; // ofRandom(0.5, 1.0);
    alpha = 1.0f;
...
void childParticle::update()
{
    ...
    switch (dispMode) {
        ...
        case PARTICLE_DISPLAY_MODE_ONOFF_ALPHA:
            ...
            alpha = pow(1.0f-cos(2.0f*M_PI*t/period),2.0f);
            doDraw = (t <= period);
            break;
    }
    //
   ...
   //     isActive = false;
        ...
        //    doDraw = true;
        //    isActive = true;
        //     //startTime = ofGetElapsedTimef() + _offsetStartTime;
        //}
    //}
	*/
...
//------------------------------------------------------------------
void childParticle::setFillMode(ofFillFlag fillFlag)
{
	_fillMode = fillFlag;
