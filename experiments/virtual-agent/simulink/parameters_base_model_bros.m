...
load('data_target_signal4.mat','nx','ny','Ax','Ay','phx','phy');
...
BROS2.Actuator1.AbsEncoderOffset = 33205/BROS1.Actuator1.JointAbsoluteEncoderCounts_rev*2*pi + asin(8/153);                     % offset absolute encoder [rad]
...
BROS2.Actuator2.AbsEncoderOffset = 14143/BROS1.Actuator2.JointAbsoluteEncoderCounts_rev*2*pi + pi - asin(8/153);                     % offset absolute encoder [rad]
...
% force/torque sensor data
BROS2.FTSensor.MaxAllowableForcesTorqueSensor = 0.7*[100 100 200 2 2 2]'; % maximum allowable forces and torques
