...
pairs = [1:5 7:12]; % pair 6 is incorrect (wrong TC model)
sessions = [1];
switchers = [];
% outliers = {'10B'};
outliers = {''};
...
%             f = dir(['.' filesep 'exp1_motorlearning_partners' num2str(pair) '_type*']);
            f = dir(['.' filesep 'exp1b_learning_pair' num2str(pair) '_type*']);
            ...
            f = dir(['.' filesep '..' filesep 'protocol_learning_pair' num2str(pair) '_session1*.mat']);
